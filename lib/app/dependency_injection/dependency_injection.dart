...
/// we will not be using any external packages for dependency injection and
///state management. We would only declare the values here and assign values
///to them in main.dart
