...
abstract class PokemonRepository {
  Future<ApiResult<PokemonList>> getPokemonList({required PokemonListParams params});
  Future<ApiResult<PokemonDetails>> getPokemonDetails({required String pokemonName});
}
